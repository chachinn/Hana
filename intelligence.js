...
(() => {
  ...
  window.HanaIntelligence={ask,search:semanticSearch,suggestions,weeklyReset,naturalDate,relationships:relationshipGroups,duplicates:duplicateGroups,conflicts,open:openIntelligence,status:()=>({localOnly:true,version:'v1',corpus:corpus().length,suggestionCount:suggestions().length})};
})();
